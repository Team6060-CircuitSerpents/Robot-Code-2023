...
// THIS INCLUDES BOTH MOTOR IDS AND ONE ENCODER ID FOR EACH WHEEL INCLUDING THE STEER OFFSET 
...
public final class Constants {
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 19.125; // Measure and set trackwidth
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 19.125; // Measure and set wheelbase
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(168 + 180); // Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(339 + 180); // Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(243); // Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(131 + 180); // Measure and set back right steer offset
}
