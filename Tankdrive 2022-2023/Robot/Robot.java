...
public class Robot extends TimedRobot {
  ...
  private AutoDrive aDrive = new AutoDrive(this);
  public ArmControl aControl = new ArmControl(3, 2, 8, 0);
  ...
  public void teleopPeriodic() {
    ...
    // Intake
    if (controls.getLB() || controls.getRT() >= 0.05){
      aControl.intake();
    }
    else if (controls.getRB() || controls.getLT() >= 0.05){
      aControl.outtake();
    }
    else{
      aControl.stopIntake();
